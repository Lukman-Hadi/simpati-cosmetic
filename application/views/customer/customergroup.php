...
<script>
	...
	const urlSave = 'saveCustomerGroup';
	const urlDelete = 'destroyCustomerGroup';
	const urlActiveNonactive = 'setActiveCustomerGroup';
	const urlSingleRow = 'getSingleCustomerGroup';
