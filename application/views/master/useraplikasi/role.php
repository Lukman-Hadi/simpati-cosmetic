		...
		<div class="col">
			<div class="card">
				...
				<div class="table-responsive py-2 px-4">
					<table id="table" data-toggle="table" data-toolbar="#toolbar" data-url="getRole" data-pagination="true" data-search="true" data-click-to-select="false" class="table table-sm" data-side-pagination="server" data-page-list="[10,20,50,all]" data-show-refresh="true" data-show-columns="true" data-show-columns-toggle-all="true">
					...
					<div class="card-body px-lg-5 py-lg-2">
						<form id="ff" method="post" enctype="multipart/form-data" class="needs-validation">
							<div class="form-group" id="nama">
								...
								<input type="text" name="nama" class="form-control form-control-sm" placeholder="Nama Role">
							</div>
							<div class="form-group" id="description">
								<label>Dekripsi Role</label>
...
<script>
	...
	const urlSave = 'saveRole';
	const urlDelete = 'destroyRole';
	const urlActiveNonactive = 'setActiveRole';
	const urlSingleRow = 'getSingleRole';
	...
	function newForm(isEdit = false) {
		...
		let text = isEdit ? 'Edit Role' : 'Input Data Role Baru';
