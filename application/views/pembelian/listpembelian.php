		...
		<div class="col">
			<div class="card">
				...
				<div class="table-responsive py-2 px-4">
					<table id="table" data-toggle="table" data-toolbar="#toolbar" data-url="getListPembelian" data-pagination="true" data-search="true" data-click-to-select="false" class="table table-sm" data-side-pagination="server" data-page-list="[10,20,50,all]" data-show-refresh="true" data-show-columns="true" data-show-columns-toggle-all="true">
						<thead class="thead-light text-center">
							<tr>
								<th data-field="invoice_no" data-width="10" data-width-unit="%" class="proper-case px-1">No Inv</th>
								<th data-field="supplier" class="px-1" data-width="10" data-width-unit="%">Supplier</th>
								<th data-field="grand_total" class="px-1" data-formatter="rupiahFormatter" data-width="10" data-width-unit="%">Total Pembelian</th>
...
<script>
	...
	function actionFormatter(val, row) {
		...
		<div class="row d-flex justify-content-center">
			<a href="listPembelianDetail/${row.id}" class="badge badge-pill badge-secondary badge-sm" data-toggle="tooltip" data-placement="top" title="Lihat Detail"><i class="fa fa-eye"></i></a>
			<a href="deleteListPenjualan/${row.id}" class="badge badge-pill badge-danger badge-sm" data-toggle="tooltip" data-placement="top" title="Hapus Barang"><i class="fa fa-trash"></i></a>
		</div>
		</div>
		`
	}
