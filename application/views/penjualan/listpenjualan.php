...
<script>
	...
	function actionFormatter(val, row) {
		...
		<div class="row d-flex justify-content-center">
			<a href="listPenjualanDetail/${row.id}" class="badge badge-pill badge-secondary badge-sm" data-toggle="tooltip" data-placement="top" title="Lihat Detail"><i class="fa fa-eye"></i></a>
